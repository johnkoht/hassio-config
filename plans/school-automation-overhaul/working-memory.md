...
- [2026-08-25] `secrets.yaml` is human-managed; no script may write to or delete it. `secrets.fake.yaml` retain-or-retire decision pending in task-1. — docs affected: `deploy.sh` — status: open
