...
- 2026-09-23 · [radio-network-offline-alerts](entries/2026-09-23_radio-network-offline-alerts-learnings.md) — Zigbee/Z-Wave/UPS offline pushes; coordinator sensor is disabled so ZHA groups are the signal; NUT apc_ups_status is "Online" not "OL", so the battery alert is likely broken
