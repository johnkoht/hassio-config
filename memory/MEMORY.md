...
- 2026-09-23 · [radio-network-offline-alerts](entries/2026-09-23_radio-network-offline-alerts-learnings.md) — Zigbee/Z-Wave/UPS offline pushes; ZHA has no coordinator entity so the trigger reads the config entry state (light groups are NOT a controller signal); NUT apc_ups_status is "Online" not "OL", so the battery alert is likely broken
